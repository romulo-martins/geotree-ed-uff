...
main: main.c lib/gentree.h lib/avl.h lib/figuras.h lib/areas.h
	gcc -o main.out main.c lib/gentree.c lib/avl.c lib/figuras.c lib/areas.c -lm
...
avl_test: tests/avl_test.c lib/avl.c lib/avl.h lib/areas.h
