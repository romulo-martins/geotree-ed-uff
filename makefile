...
main: main.c lib/gentree.h lib/avl.h lib/pilha.h lib/figuras.h lib/areas.h
	gcc -o main.out main.c lib/gentree.c lib/avl.c lib/pilha.c lib/figuras.c lib/areas.c -lm
